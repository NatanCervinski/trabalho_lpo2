...
import locadora.ConnectionFactory;
...
public void add(Cliente cliente) throws Exception {
    try (Connection connection = ConnectionFactory.getConnection();
        ...
        stmtAdicionaEndereco.setInt(2, cliente.getEndereco().getNumero());
        ...
        try (Connection connection=ConnectionFactory.getConnection();
            ...
            try (ResultSet rs = stmtLista.executeQuery()) {
                if (rs.next()) {
                    ...
                    String rg= rs.getString("rg");
                    String cpf= rs.getString("cpf");
                    Endereco endereco = new Endereco(rs.getString("rua"),rs.getInt("numero"),rs.getString("complemento"));
